...
trait StaticCreation
{
    ...
    /**
     * Deny default creation of the repository, we do need it anymore,
     * just use ExampleRepository::make() instead of
     *
     * @param \TYPO3\CMS\Extbase\Object\ObjectManagerInterface $objectManager
     */
    private function __construct(ObjectManagerInterface $objectManager)
    {
